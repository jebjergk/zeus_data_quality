...
USING (
    SELECT
        ...
        DATA_TYPE_FAMILY,
        PARSE_JSON(APPLICABILITY_TAGS_JSON) AS APPLICABILITY_TAGS,
        DEFAULT_SUGGEST,
        SUGGESTION_PRIORITY,
        CATEGORY,
        SEVERITY,
    ...
    FROM (
        SELECT * FROM VALUES
            ...
            AS v(RULE_CODE, SCOPE, ENGINE_TYPE, EXPRESSION, PARAM_SCHEMA_JSON, DEFAULT_PARAMS_JSON, ALLOWED_DATA_TYPES_JSON, ALLOWED_CLASSIFICATIONS_JSON, DATA_TYPE_FAMILY, APPLICABILITY_TAGS_JSON, DEFAULT_SUGGEST, SUGGESTION_PRIORITY, CATEGORY, SEVERITY, ENABLED, VERSION, CHECK_TYPE)
    )
) AS source
...
WHEN MATCHED THEN UPDATE SET
    ...
    DATA_TYPE_FAMILY = source.DATA_TYPE_FAMILY,
    APPLICABILITY_TAGS = source.APPLICABILITY_TAGS,
    DEFAULT_SUGGEST = source.DEFAULT_SUGGEST,
    SUGGESTION_PRIORITY = source.SUGGESTION_PRIORITY,
...
WHEN NOT MATCHED THEN INSERT (
    ...
    ALLOWED_DATA_TYPES, ALLOWED_CLASSIFICATIONS, DATA_TYPE_FAMILY, APPLICABILITY_TAGS, DEFAULT_SUGGEST, SUGGESTION_PRIORITY, CATEGORY, SEVERITY, ENABLED, VERSION,
    ...
    source.DATA_TYPE_FAMILY,
    source.APPLICABILITY_TAGS,
    source.DEFAULT_SUGGEST,
    source.SUGGESTION_PRIORITY,
    source.CATEGORY,
    source.SEVERITY,
    source.ENABLED,
    source.VERSION,
